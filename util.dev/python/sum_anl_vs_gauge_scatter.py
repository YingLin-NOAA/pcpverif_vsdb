...
plt.xlim((0,50))
plt.ylim((0,50))
DATDIR='/meso/save/Ying.Lin/verf.grid2gauge.dat/sums/'
infile1=DATDIR+'g2g_ccpa_09-23Feb.dat'
infile2=DATDIR+'g2g_ccpax_09-23Feb.dat'
infile3=DATDIR+'g2g_ST4_09-23Feb.dat'
# plot diagonal line:
x = arange(0., 51., 1)
...
#
title('24h analyses vs daily gauges, 9-23 Feb 2016')
fig1 = plt.figure(1)
