             ...
             while [ $lp -le $nlp ] ; do
              ...
              if [ $ens = 'ecme' ] ; then
                ...
                while [ $timelp -lt ${tfcst[0]} ] ; do                 # for all previous forecast cycles
                  ...
                  # YL Check to see if the file exist.  For example, there is
                  # no href.ens07.t18z.apcp.f36.grib2, because href members
                  # 06-08 for 06/18Z only goes out to 30h.
                ...
                fi # if the file in question exists
                  timelp=`expr $timelp + 1` 
